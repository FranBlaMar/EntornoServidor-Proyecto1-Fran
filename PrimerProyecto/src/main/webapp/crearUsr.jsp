...
<body>
	<div class="cuadrado">
		...
		<!-- Un formulario de creacion de usuario, con el mismo name que los atributos del bean -->
		<form class="formularioUsuario" action="main.jsp" method="POST">
			<label>Nombre: <input type="text" id="nombre" name="nombre"></label><br><br>
               ...
               <label>Fecha Nacimiento (Año-Mes-Día): <input type="text" id="fecha" name="fechaNacimiento"></label><br><br>
               <label>
